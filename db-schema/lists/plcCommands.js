...
var plcCommandTriggerHandler_1 = require("../../triggers/plcCommandTriggerHandler");
                ...
                validateInput: function (props) {
                    ...
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    console.log('plCommand triggers' + ((_a = props === null || props === void 0 ? void 0 : props.existingItem) === null || _a === void 0 ? void 0 : _a.operation));
                                    if (!(props.operation == "update")) return [3 /*break*/, 2];
                                    return [4 /*yield*/, plcCommandTriggerHandler_1["default"].validateStatus(props)];
                                case 1:
                                    result = _b.sent();
                                    if (!result) {
                                    ...
                                    ;
                                    _b.label = 2;
                                case 2: return [2 /*return*/, props.resolvedData];
                            }
                        });
                    });
                }
